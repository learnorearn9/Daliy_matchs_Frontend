...
export default function UserTournaments() {
  ...
  const visibleTournaments = showAll
    ? filteredTournaments
    : filteredTournaments.slice(0, 3); // Show only 3 tournaments if showAll is false
                    ...
                    <div className="mid-area">
                      ...
                      <div className="title-bottom d-flex">
                        ...
                        <div className="date-area bg">
                          <span>
                            {format(
                              subMinutes(subHours(tournament.startTime, 5), 30),
                              "MMM dd, yyyy"
                            )}
                            &nbsp;
                          </span>
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                {token ? (
                  ...
                  <button
                    className="cmn-btn"
                    style={{ color: "white" }}
                    onClick={() => navigate("/login")} // Redirect to the tournaments page
                  >
                    View More
                  </button>
                )}
